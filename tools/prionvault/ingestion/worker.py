...
def _upsert_article(**kw) -> str:
    ...
    with eng.begin() as conn:
        ...
        if existing_id:
            ...
            fixed_cols = ["extraction_status", "added_by_id", "created_at", "updated_at"]
            fixed_vals = "'extracted', :added_by_id, NOW(), NOW()"
            if "extraction_status" not in db_cols:
                fixed_cols = ["added_by_id", "created_at", "updated_at"]
                fixed_vals = ":added_by_id, NOW(), NOW()"
