...
_BUILTIN_ARTICLES = {
    ...
    'prionvault-govasco-export': {
        ...
        'content_es': (
            ...
            '2. Pulsa el año que quieras (o **⬇ Descargar los 6 últimos**). La app lo '
            '**descarga sola** desde scimagojr.com, calcula percentiles/deciles por categoría, '
            'lo guarda en la base de datos y archiva una copia del CSV en Dropbox. No tienes '
            'que subir nada a mano.\n'
            ...
            '- La descarga automática requiere que el servidor tenga salida a scimagojr.com; '
            'si tu red la bloquea, usa la subida manual del CSV.\n'
        ...
        'content_en': (
            ...
            '2. Click the year you want (or **⬇ Download the last 6**). The app '
            '**downloads it itself** from scimagojr.com, computes per-category '
            'percentiles/deciles, stores it in the database and archives a copy of the CSV '
            'to Dropbox. No manual upload needed.\n'
            ...
            'available yet.\n'
            '- Auto-download requires the server to reach scimagojr.com; if your network '
            'blocks it, use the manual CSV upload.\n'
