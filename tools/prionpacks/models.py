...
DEMO_PACKAGES = [
    {
        ...
        "gaps": {"missingInfo": ["Análisis estadístico de cohorte mayor (n<12)", "Datos de supervivencia neuronal longitudinal"], "neededExperiments": ["Western blot cuantitativo en fracciones solubles/insolubles"]},
    ...
    },
    {
        ...
        "gaps": {"missingInfo": ["Modelo in vitro de transmisión célula-a-célula"], "neededExperiments": ["FRET entre neuronas para confirmar transferencia directa"]},
    ...
    },
    {
        ...
        "gaps": {"missingInfo": ["Estudios longitudinales >5 años de seguimiento"], "neededExperiments": ["Validación prospectiva en cohorte multicéntrica española"]},
    ...
    },
    {
        ...
        "type": "case",
        "priority": "low",
        "hypothesis": "Los pacientes con vECJ que debutan con síntomas psiquiátricos presentan retraso diagnóstico significativo y patrón de RM característico con DWI positivo tardío.",
        "findings": [
...
def create_package(data: dict) -> dict:
    ...
    pkg = {
        ...
        'gaps': data.get('gaps', {'missingInfo': [], 'neededExperiments': []}),
        'scores': data.get('scores', {'hypothesis': 0, 'findings': 0, 'figures': 0, 'gaps': 0, 'total': 0}),
        'createdAt': now,
        'lastModified': now,
    }
    packages.append(pkg)
